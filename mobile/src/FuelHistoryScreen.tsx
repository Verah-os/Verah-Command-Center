...
const styles = StyleSheet.create({
  ...
  latestValue: { color: "#814455", fontSize: 30, fontWeight: "800", marginTop: 8 },
  ...
  fuelPill: { borderWidth: 1, borderColor: "#814455", borderRadius: 999, paddingHorizontal:  11, paddingVertical: 8 },
  fuelPillActive: { backgroundColor: "#814455" },
  fuelPillText: { color: "#814455", fontSize: 13, fontWeight: "700" },
  fuelPillTextActive: { color: "#FFFFFF" },
  modeRow: { flexDirection: "row", gap: 8, marginBottom:  14 },
  modePill: { borderWidth: 1, borderColor: "#814455", borderRadius: 999, paddingHorizontal:  16, paddingVertical:  10 },
  modePillActive: { backgroundColor: "#814455" },
  modePillText: { color: "#814455", fontSize: 14, fontWeight: "700" },
  ...
  rowConsumption: { color: "#814455", fontSize:  13, fontWeight: "700", marginTop:  4 },
