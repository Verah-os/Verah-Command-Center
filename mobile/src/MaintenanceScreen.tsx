...
const styles = StyleSheet.create({
  ...
  title: { fontSize:  24, fontWeight: "700", color: "#177F78" },
  ...
  secondaryButton: { padding:  14, borderWidth:  1, borderColor: "#177F78", borderRadius: 12 },
  secondaryButtonText: { color: "#177F78", textAlign: "center", fontWeight: "600" },
  assistButton: { padding:  14, backgroundColor: "#E7F2F0", borderRadius: 12 },
  assistButtonText: { color: "#177F78", textAlign: "center", fontWeight: "700" },
  saveButton: { padding: 16, backgroundColor: "#177F78", borderRadius: 12 },
