...
const styles = StyleSheet.create({
  ...
  brandName: { color: "#E8B6C0", fontSize: 32, fontWeight: "700" },
  eyebrow: { color: "#E8B6C0", fontSize: 14, fontWeight: "600", marginTop: 16 },
  ...
  choice: { backgroundColor: "#242424", borderColor: "#E8B6C0", borderRadius: 12, borderWidth: 1, marginBottom: 12, padding: 16, width: "100%" },
  ...
  chipSelected: { backgroundColor: "#E8B6C0", borderColor: "#E8B6C0" },
  ...
  fipeText: { color: "#E8B6C0", fontSize: 14, fontWeight: "600", marginTop: 8, marginBottom: 14 },
  checkRow: { flexDirection: "row", alignItems: "flex-start", marginTop: 4, marginBottom: 8, width: "100%" },
  check: { width: 22, height: 22, borderRadius: 6, borderWidth: 1, borderColor: "#E8B6C0", alignItems: "center", justifyContent: "center", marginTop: 2, marginRight: 12, flexShrink: 0 },
  checkSelected: { backgroundColor: "#E8B6C0" },
  ...
  primary: { backgroundColor: "#E8B6C0", borderRadius: 8, marginTop: 16, paddingVertical: 12, alignItems: "center", width: "100%" },
  primaryText: { color: "#0B0B0B", fontSize: 16, fontWeight: "700" },
  disabled: { opacity: 0.6 },
  outline: { borderWidth: 1, borderColor: "#E8B6C0", borderRadius: 8, marginTop: 16, paddingVertical: 12, alignItems: "center", width: "100%" },
  outlineText: { color: "#E8B6C0", fontSize: 16, fontWeight: "600" },
});
