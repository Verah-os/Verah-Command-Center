...
const styles = StyleSheet.create({
  ...
  kindPill: { borderWidth:  1, borderColor: "#177F78", borderRadius:  999, paddingHorizontal:  11, paddingVertical:  8 },
  kindPillActive: { backgroundColor: "#177F78" },
  kindPillText: { color: "#177F78", fontSize:  13, fontWeight: "700" },
