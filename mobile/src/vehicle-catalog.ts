export const vehicleCatalog = {
  Volkswagen: ["Fox", "Gol", "Polo", "Virtus", "Nivus", "T-Cross", "Saveiro", "Voyage", "Taos", "Tiguan"],
  Chevrolet: ["Onix", "Onix Plus", "Tracker", "Spin", "S10", "Montana", "Cruze", "Cobalt"],
  Fiat: ["Argo", "Mobi", "Cronos", "Pulse", "Fastback", "Strada", "Toro", "Uno", "Palio"],
  Ford: ["Ka", "Fiesta", "EcoSport", "Ranger", "Territory", "Maverick", "Focus"],
  Toyota: ["Corolla", "Corolla Cross", "Yaris", "Hilux", "SW4", "Etios", "RAV4"],
...
export function modelsForBrand(brand: string): readonly string[] {
  return Object.prototype.hasOwnProperty.call(vehicleCatalog, brand)
    ? vehicleCatalog[brand as VehicleBrand]
    : [];
}
