...
export function ProviderTrustPanel({
  ...
  return (
    <section aria-label="Confiança na recomendação" className="rounded-2xl border border-accent/25 bg-gradient-to-br from-rose-50 to-white p-4">
      ...
      <p className="mt-4 border-t border-accent/25 pt-4 text-sm leading-6 text-slate-600">{reason}</p>
    </section>
  );
}
