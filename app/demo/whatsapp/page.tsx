    ...
    <DemoShell showLogout={false}>
      <section className="mx-auto max-w-2xl px-5 py-12 sm:py-20">
        <div className="rounded-[2rem] border border-rose-100 bg-white p-6 shadow-[0_24px_80px_rgba(87,54,67,0.10)] sm:p-10">
          ...
          <Link
            href="/"
            className="mt-4 inline-flex min-h-11 w-full items-center justify-center rounded-xl border border-accent/40 px-5 text-sm font-semibold text-accent outline-none hover:bg-accent/10 focus-visible:ring-4 focus-visible:ring-accent/30"
          >
