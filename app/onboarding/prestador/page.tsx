...
export default function ProviderOnboardingPage() {
  return <main className="provider-surface flex min-h-screen items-center justify-center p-5">
    <Card className="w-full max-w-lg p-6 text-center sm:p-9">
      <p className="text-sm font-semibold text-accent">Candidatura recebida</p>
      ...
      <Link href="/entrar/prestador" className="mt-6 inline-block font-semibold text-accent">Voltar ao acesso</Link>
    </Card>
  </main>;
}
